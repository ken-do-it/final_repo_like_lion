      ...
      <main className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-10">
        ...
        <section className="flex flex-col items-center justify-center pt-8 pb-4 space-y-6">
          ...
          <div className="flex gap-3 overflow-x-auto w-full justify-center py-2 no-scrollbar">
            ...
            <button className="flex items-center gap-2 px-5 py-2.5 rounded-full bg-white dark:bg-[#1e2b36] text-slate-600 dark:text-slate-300 shadow-sm border border-slate-200 dark:border-slate-700 hover:border-[#1392ec]/50 hover:text-[#1392ec] transition-all hover:-translate-y-0.5" onClick={() => navigate('/local-columns')}>
              <span className="text-[20px]">🥘</span>
              <span className="text-sm font-medium">Local Column</span>
            </button>
          </div>
        </section>
