...
const TrainSearch = () => {
   ...
   */
  const stations = [
    { nodeId: 'NAT010000', nodeName: '서울', region: '수도권' },
    { nodeId: 'NAT010032', nodeName: '용산', region: '수도권' },
    { nodeId: 'NAT010107', nodeName: '영등포', region: '수도권' },
    { nodeId: 'NAT010415', nodeName: '수원', region: '수도권' },
    { nodeId: 'NAT010856', nodeName: '천안아산', region: '충청' },
    { nodeId: 'NAT011668', nodeName: '대전', region: '충청' },
    { nodeId: 'NAT013417', nodeName: '동대구', region: '경상' },
    { nodeId: 'NAT013726', nodeName: '신경주', region: '경상' },
    { nodeId: 'NAT013854', nodeName: '울산(통도사)', region: '경상' },
    { nodeId: 'NAT014445', nodeName: '부산', region: '경상' },
    { nodeId: 'NAT040407', nodeName: '광주송정', region: '전라' },
    { nodeId: 'NAT030951', nodeName: '전주', region: '전라' },
    { nodeId: 'NAT040883', nodeName: '목포', region: '전라' },
    { nodeId: 'NAT041147', nodeName: '여수엑스포', region: '전라' },
    { nodeId: 'NAT020393', nodeName: '강릉', region: '강원' },
  ];
