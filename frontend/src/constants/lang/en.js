export default {
    ...
    country_placeholder: "e.g. South Korea",
    city_label: "City",
    login_btn: "Login",
    signup_btn: "Sign Up",
    ...
    see_all: "See all",
    search_tab_all: "All",
    search_tab_places: "Places",
    search_tab_plans: "Plans",
    search_tab_shorts: "Shorts",
    search_tab_reviews: "Reviews",
    search_tab_others: "Others",
    search_header_places: "Recommended Places",
    search_header_shorts: "Shorts",
    search_header_plans: "Popular Itineraries",
    search_header_flights: "Flights",
    search_header_transports: "Transport",
    search_header_reviews: "From Travelers",
    search_header_others: "Other Results",
    search_loading: "Searching for \"{query}\"...",
    search_no_results_title: "Ready to explore?",
    search_no_results_desc: "Search for destinations, hotels, or guides.",
