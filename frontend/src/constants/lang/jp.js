export default {
    ...
    birth_year_label: "生まれ年",
    country_label: "国",
    country_placeholder: "例: 韓国",
    city_label: "都市",
    login_btn: "ログイン",
    signup_btn: "会員登録",
    ...
    badge_since: "認証開始",
    badge_months: "継続月数",
    badge_months_unit: "ヶ月",
    badge_level: "レベル",
    badge_writer: "ライター",
    badge_explorer: "エクスプローラー",
    no_local_badge: "まだ現地人バッジがありません。",
    no_local_badge_desc: "現地に一定期間滞在するとバッジを獲得できます！",

    // マイページ追加翻訳
    profile_update_failed: "プロフィールの更新に失敗しました。",
    confirm_remove_bookmark: "この場所をブックマークから削除しますか？",
    remove_bookmark_failed: "ブックマークの削除に失敗しました",
    confirm_delete_review: "このレビューを削除しますか？",
    delete_review_failed: "レビューの削除に失敗しました",
    upload_first_short: "最初のショート動画をアップロードしましょう！",
    create_first_plan: "最初の旅行計画を作成しましょう！",
    unit_days: "日",
    view_details: "詳細を見る →",
    read_more: "もっと見る →",
    preferences_desc: "言語と通貨の設定です。",
    label_language: "言語",
    label_currency: "通貨",
    status_pending: "保留中",
    status_cancelled: "キャンセル済み",
    no_columns_yet: "まだコラムがありません",
    columns_empty_desc: "旅行者にローカル情報を共有しましょう！",
    write_column: "コラムを書く",
    my_columns: "マイコラム",
    no_saved_places: "保存した場所がありません",
    saved_places_empty_desc: "後で訪れたい場所をブックマークしましょう！",
    explore_places: "場所を探す",
    saved_places: "保存した場所",
    btn_remove: "削除",
    no_reviews_yet: "まだレビューがありません",
    reviews_empty_desc: "他の人と体験を共有しましょう！",
    find_places_to_review: "レビューする場所を探す",
    my_reviews: "マイレビュー",
    ...
    see_all: "すべて見る",
    search_tab_all: "すべて",
    search_tab_places: "場所",
    search_tab_plans: "プラン",
    search_tab_shorts: "ショート",
    search_tab_reviews: "レビュー",
    search_tab_others: "その他",
    search_header_places: "おすすめの場所",
    search_header_shorts: "ショート",
    search_header_plans: "人気のプラン",
    search_header_flights: "フライト",
    search_header_transports: "交通",
    search_header_reviews: "旅行者のレビュー",
    search_header_others: "その他の結果",
    search_loading: "\"{query}\"を検索中...",
    search_no_results_title: "準備はいいですか？",
    search_no_results_desc: "目的地、ホテル、ガイドを検索してみてください。",
    search_empty_title: "\"{tab}\"に関する結果がありません。",
    search_empty_desc: "検索語やフィルターを調整してみてください。",
    info_route_3: "各駅で初電・終電時刻を確認してください。",
    info_route_4: "駅の案内板でリアルタイム到着情報を確認してください。",
    label_provider: "提供：",

    // フッター
    footer_desc: "AI旅程と現地情報で韓国の魅力を発見しましょう。",
    footer_explore: "探索",
    footer_destinations: "目的地",
    footer_trending_shorts: "人気ショート",
    footer_hotels: "ホテル",
    footer_company: "会社情報",
    footer_about: "会社概要",
    footer_contact: "お問い合わせ",
    footer_privacy: "プライバシーポリシー",
    footer_stay_updated: "最新情報",
    ...
    // サイドバー
    sidebar_title: "韓国旅行",
    sidebar_copyright: "Tripko プラットフォーム",

    // プラン詳細 - 画像
    alert_image_only: "画像ファイルのみアップロードできます。",
    alert_image_size: "画像サイズは10MB以下にしてください。",
    alert_image_upload_fail: "画像のアップロードに失敗しました。",
    confirm_image_delete: "この画像を削除しますか？",
    alert_image_delete_fail: "画像の削除に失敗しました。",
    btn_add_image: "写真追加",
    anonymous: "匿名"
};
